...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _plugins_plugins__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./plugins/plugins */ \"./src/plugins/plugins.js\");\n/* harmony import */ var _msg_Log__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./msg/Log */ \"./src/msg/Log.js\");\n/* harmony import */ var _timeCode_main_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./timeCode/main.js */ \"./src/timeCode/main.js\");\n\r\n\r\n\r\n\r\n\r\nconst author='TiViAl';\r\nsetAppReadyEvent(onAppReady);\r\n\r\nlet log = new _msg_Log__WEBPACK_IMPORTED_MODULE_1__[\"default\"](author, 'Main');\r\nlog.event('load');\r\n\r\n_plugins_plugins__WEBPACK_IMPORTED_MODULE_0__[\"default\"].addPluginOnline();\r\n_timeCode_main_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].init(author);\r\n\r\n\r\n\r\n\r\nlog.event('loaded');\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nfunction onAppReady() {\r\n  console.log(author, 'onAppReady');\r\n}\r\n\r\nfunction setAppReadyEvent(onAppReadyAction) {\r\n  Lampa.Listener.follow('app', (e)=>{\r\n      console.log(author, 'setAppReadyEvent', e.type);\r\n      if (e.type == 'ready') {\r\n        onAppReadyAction();\r\n      }\r\n    });\r\n}\r\n\r\n\r\n\r\n\r\n// function showPathes() {\r\n//   log.eventParam('__dirname', __dirname);\r\n//   log.eventParam('__filename', __filename);\r\n//   log.eventParam('window.location.href', window.location.href);\r\n// }\n\n//# sourceURL=webpack:///./src/main.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nfunction addPluginOnline() {\r\n    addPlugin('nb557', 'online', 'https://nb557.github.io/plugins/online_mod.js');\r\n}\r\n\r\nfunction addPlugin(author, name, url) {\r\n  const existPlug = Lampa.Plugins.get().find(a=>a.url==url);\r\n  if(!existPlug){\r\n    Lampa.Plugins.push({url: url, status: 1, name: name, author: author});\r\n  }\r\n}\r\n\r\n\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({\r\n    addPluginOnline\r\n});\n\n//# sourceURL=webpack:///./src/plugins/plugins.js?");
